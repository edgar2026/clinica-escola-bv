...
export const RelatoriosPage = () => {
  ...
  const [resultados, setResultados] = useState<{ tipo: string; total: number; dados: any[] } | null>(null);
              ...
              <table>
                ...
                <tbody>
                  {resultados.dados.map(d => {
                    const cfg = STATUS_LABEL[d.status_frequencia as keyof typeof STATUS_LABEL] || { label: d.status_frequencia, cls: 'amarelo' };
                    return (
                      <tr key={d.id}>
